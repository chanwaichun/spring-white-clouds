...
public class CommonResult<T> {
     ...
     * @param  message 提示信息
     */
    public static <T> CommonResult<T> success(long successCode, T data, String message) {
        return new CommonResult<T>(successCode, message, data);
    }
